...
<head>
<meta charset="UTF-8">
<title>${SWORD} 검색결과 - 현재 필터: ${SCODE}, ${FILTERBUTTON}</title>
...
<script type="text/javascript" src="/project/js/search/searchResultFilter.js"></script>
...
<body>
	<form class="w3-container w3-center w3-border w3-light-blue mlrauto" style="height:100px;width: 100%;" 
		...
		placeholder="제품을 검색하세요" style="width: 750px;">
		<input type="hidden" name="searchword" id="searchword" value="${SWORD}">
		<input type="hidden" name="scode" id="scode" value="${SCODE}">
		<input type="hidden" name="filterbutton" id="filterbutton" value="${FILTERBUTTON}">
	</form>	
