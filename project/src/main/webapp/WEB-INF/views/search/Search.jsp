...
<script type="text/javascript" src="/project/js/search/searchMain.js"></script>
...
<form class="w3-container w3-center w3-border w3-light-blue mlrauto" style="height:100px; width: 100%;" 
		method="POST" action="/project/search/searchResult.project" id="frm" name="frm">
	...
	<input type="hidden" name="filterbutton" id="filterbutton">
</form>
