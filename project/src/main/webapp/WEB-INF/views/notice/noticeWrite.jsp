		...
		<div class="w3-col m10 w3-margin-top">
			<form method="POST" id="frm">
				<div class="w3-col w3-border w3-margin-top w3-center">
					<div class="w3-col m12 w3-light-grey w3-border-right">내용</div>
				</div>

				<div class="w3-col w3-border-left w3-border-right w3-margin-bottom " >
					<div class="w3-col w3-center w3-border-bottom" >
						<div class="w3-col w3-border-left m12 w3-margin-top">
							<textarea class="w3-col w3-margin w3-border " style="width: 600px; height: 50px;" id="title" name="title" ></textarea>
							<textarea class="w3-col w3-margin w3-border w3-padding " style="width: 600px; height: 300px;" id="contents" name="contents" ></textarea>
						</div>
					</div>
				</div>
			</form>
			<div class="w3-left m2 w3-btn w3-border" id="editCancleBtn">취소</div>
			<div class="w3-right m2 w3-btn w3-border" id="writeProcbtn">완료</div>
		</div>
	</div>
</body>
</html>